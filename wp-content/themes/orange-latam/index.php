			...
			<div class="services-corp__grid">
				<div class="services-corp__list" data-reveal="left">
					...
					$services_data = array(
						...
						array( 'id' => 5, 'num' => '05', 'name' => 'Producción Audiovisual Orange Studio', 'desc' => 'Producción de video, fotografía y animación de primer nivel para todas las plataformas y formatos del ecosistema digital y tradicional.', 'link' => home_url( '/podcast/' ), 'file' => 'produccion-audiovisual.png' ),
						array( 'id' => 6, 'num' => '06', 'name' => 'Creatividad y Dirección de Arte', 'desc' => 'El diferencial creativo que hace que tu comunicación se destaque y genere el impacto deseado en el público objetivo.', 'link' => home_url( '/branding-creatividad/#creatividad-direccion-arte' ), 'file' => 'creatividad-arte.png' ),
						array( 'id' => 7, 'num' => '07', 'name' => 'Branding', 'desc' => 'De naming a consolidación: creamos y posicionamos marcas memorables y deseadas en mercados nacionales e internacionales.', 'link' => home_url( '/branding-creatividad/' ), 'file' => 'branding.png' ),
						array( 'id' => 8, 'num' => '08', 'name' => 'Estratégias ATL', 'desc' => 'Campañas de alto alcance con planificación de medios, segmentación de audiencias y ejecución integrada con el mejor ROI del mercado.', 'file' => 'estrategias-atl.png' ),
						array( 'id' => 9, 'num' => '09', 'name' => 'Eventos y Activaciones Presenciales', 'desc' => 'Experiencias presenciales, remotas e híbridas de primer nivel que conectan con el público de manera poderosa y memorable.', 'file' => 'eventos-presenciales.png' ),
						...
						array( 'id' => 11, 'num' => '11', 'name' => 'SEO / SEM', 'desc' => 'Optimizamos la presencia digital con estrategias de búsqueda integradas a los objetivos comerciales e institucionales de la marca.', 'file' => 'seo-sem.png' ),
						array( 'id' => 12, 'num' => '12', 'name' => 'Web site / Landing UX Criteria', 'desc' => 'Diseñamos experiencias digitales que convierten, con navegación intuitiva, visual atractivo y arquitectura de información óptima.', 'file' => 'website-ux.png' ),
						array( 'id' => 13, 'num' => '13', 'name' => 'E-Commerce', 'desc' => 'Plataformas y estrategias digitales completas para potenciar ventas, captación de leads y fidelización de clientes.', 'file' => 'ecommerce.png' ),
					);
