		...
		'hasOfferCatalog'     => array(
			...
			'itemListElement' => array(
				...
				array(
					...
					'itemOffered' => array(
						'@type'       => 'Service',
						'name'        => 'Asuntos Públicos y Gestión de Acceso',
						'description' => 'Monitoreo regulatorio, relacionamiento con stakeholders gubernamentales, advocacy corporativo, gestión de acceso y articulación social.',
				...
				array(
					...
					'itemOffered' => array(
						'@type'       => 'Service',
						'name'        => 'Políticas Públicas y Acceso para la Salud (Market Access)',
				...
				array(
					...
					'itemOffered' => array(
						'@type'       => 'Service',
						'name'        => 'Branding y Dirección de Arte',
						'description' => 'Naming estratégico, diseño de identidad visual, Brand Guidelines, storytelling y dirección de arte conceptual.',
				...
				array(
					...
					'itemOffered' => array(
						...
						'description' => 'Producción integral de eventos corporativos de alto impacto, lanzamientos de marca, activaciones BTL y experiencias híbridas.',
				...
				array(
					...
					'itemOffered' => array(
						'@type'       => 'Service',
						'name'        => 'Presencia Digital: Web, SEO y E-Commerce',
						'description' => 'Desarrollo web a medida con WordPress y Next.js, diseño UX/UI accesible, optimización SEO técnico/SEM y plataformas e-commerce.',
				...
				array(
					...
					'itemOffered' => array(
						...
						'description' => 'Estrategia integral de redes sociales, pauta digital en Meta Ads, Google Ads y LinkedIn Ads, analítica web y captación de leads.',
				...
				array(
					...
					'itemOffered' => array(
						'@type'       => 'Service',
						'name'        => 'Estudio de Podcast, Streaming y Producción Audiovisual',
						'description' => 'Estudio profesional de podcast y streaming en Miraflores con cámaras 4K, microfonía Shure/Rode, escenografía y postproducción.',
